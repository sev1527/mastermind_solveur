...
#        Checkbutton(self, text="Autoriser les doublons.", variable=self.doublons, command=fonction(showwarning, "Attention", "Cette fonction ne marche pas encore !")).pack()
